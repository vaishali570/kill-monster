...
function setup() {
  ...
  box22 = new Box(700, 100, 50,50);
  box23 = new Box(700, 100, 50,50);
  box24 = new Box(700, 100, 50,50);
  box25 = new Box(400, 100, 50,50);
  box26 = new Box(700, 100, 50,50);
  box27 = new Box(400, 100, 50,50);
  box28 = new Box(700, 100, 50,50);
  box29 = new Box(800, 100, 50,50);
  box30 = new Box(600, 100, 50,50);
